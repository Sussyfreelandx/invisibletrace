  ...
  const team = [
    {
      ...
      bio: "15+ years in cybersecurity and digital forensics"
    },
    {
      name: "Sarah Chen",
    ...
    <div className="bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-gray-900 to-cyan-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl font-bold mb-6">About Invisible Trace Technology</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Leading cybersecurity experts dedicated to protecting and recovering your digital assets with cutting-edge technology and unmatched expertise.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                Our founders, experienced cybersecurity professionals, recognized the growing threats to personal and corporate digital assets.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                What started as a small team of dedicated experts has grown into a leading cybersecurity firm, 
                serving clients across the globe with innovative solutions for digital forensics, data recovery, and security investigations.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3" />
                  <span className="text-gray-700">Over 500 successful cases completed</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3" />
                  <span className="text-gray-700">$2.5M+ in recovered digital assets</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                To provide world-class cybersecurity services that protect, recover, and secure digital assets 
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                To be the global leader in cybersecurity solutions, setting industry standards for 
                digital forensics, data recovery, and security investigations worldwide.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Our commitment to excellence sets us apart in the cybersecurity industry
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Experienced professionals dedicated to your digital security
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
